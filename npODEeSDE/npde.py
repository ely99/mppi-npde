...
from npODEeSDE.integrators import ODERK4, SDEEM
from npODEeSDE.kernels import OperatorKernel

from gpflow import transforms
from npODEeSDE.param import Param
...
class BrownianMotion:
    ...
    def g(self,X,t):
        ...
        dw = tf.random.normal(tf.shape(X),dtype=float_type)
